...
namespace Tutorial_31___AR_Drone {
  ...
  public partial class Form1 : Form {
    ...
    void _camera_OnNewFrame() {
      ...
      ObjectLocation objectLocation = _camera.CameraBasicColorDetection.GetObjectLocationByColor(true, EZ_B.CameraDetection.ColorDetection.ColorEnum.Red, 50, 100);
